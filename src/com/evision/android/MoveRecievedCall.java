...
public class MoveRecievedCall extends BaseActivity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		UpdateReciveCallList receiveCall = new UpdateReciveCallList();
		receiveCall.execute();
				...
				if (ACTION_DOWN == event.getAction()) {
					...
					if (scrollUp == true) {
						if (isFilesExist() == true) {
							...
							stop();
							speak(ResourceUtil.getStringFromResource(MoveRecievedCall.this,R.string.moveRevcal_empty));
						}
					}
	...
	private void ttsForEbookListMenu() {
		stop();
		speak(ResourceUtil.getStringFromResource(MoveRecievedCall.this,R.string.moveRevcal_welcome));
		speak(ResourceUtil.getStringFromResource(MoveRecievedCall.this,R.string.please));
		speak(ResourceUtil.getStringFromResource(MoveRecievedCall.this,R.string.scroll_up));
		speak(ResourceUtil.getStringFromResource(MoveRecievedCall.this,R.string.scroll_down));
		speak(ResourceUtil.getStringFromResource(MoveRecievedCall.this,R.string.fg_call));
		speak(ResourceUtil.getStringFromResource(MoveRecievedCall.this,R.string.previous_hg));
	}

	/**
	 * 
	 * To get Receive call list from Call history 
	 */

	private class UpdateReciveCallList extends AsyncTask<String, Void, String> 
	{  
