...
public class ManualMenu extends BaseActivity {
	...
	private void ttsFornoteReadMenu() {
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.manualmenu_welcome));
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.please));
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.manualmenu_one));
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.manualmenu_two));
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.manualmenu_three));
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.manualmenu_nine));
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.repeat_0));
		speak(ResourceUtil.getStringFromResource(ManualMenu.this, R.string.previous_hg));
	}
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			case R.id.num1Button:
				...
				if (ACTION_DOWN == event.getAction()) {
					...
					speak(ResourceUtil.getStringFromResource(ManualMenu.this,R.string.not_assign));
					num1Button.setBackgroundResource(R.drawable.btn_normal);
					launchApp.putExtra(BrailleCommonUtil.APP_NAME_INTENT,"cellphone.txt");
					launchApp.putExtra("className","ManualMenu");
			...
			case R.id.num2Button:
				...
				if(event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					launchApp.putExtra(BrailleCommonUtil.APP_NAME_INTENT,"education.txt");
					launchApp.putExtra("className","ManualMenu");
					launchApp.setClassName(PackageUtil.PACKAGE,PackageUtil.NOTEPADREAD);
					startActivity(launchApp);
					finish();
			...
			case R.id.num9Button:
				if(event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					launchApp.setClassName(PackageUtil.PACKAGE,PackageUtil.ACCESSORIESMANUAL);
					startActivity(launchApp);
					finish();
				} 
			...
			case R.id.numHashButton:
				if(event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					launchApp.putExtra(BrailleCommonUtil.APP_NAME_INTENT,"introduction.txt");
					launchApp.putExtra("className","ManualMenu");
					launchApp.setClassName(PackageUtil.PACKAGE,PackageUtil.NOTEPADREAD);
					startActivity(launchApp);
					finish();
