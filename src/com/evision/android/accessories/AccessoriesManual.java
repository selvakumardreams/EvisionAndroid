...
public class AccessoriesManual extends BaseActivity {
	...
	private void ttsFornoteReadMenu() {
		speak(ResourceUtil.getStringFromResource(AccessoriesManual.this, R.string.accessoriesmanual_welcome));
		speak(ResourceUtil.getStringFromResource(AccessoriesManual.this, R.string.please));
		speak(ResourceUtil.getStringFromResource(AccessoriesManual.this, R.string.accessoriesmanual_one));
		speak(ResourceUtil.getStringFromResource(AccessoriesManual.this, R.string.accessoriesmanual_two));
		speak(ResourceUtil.getStringFromResource(AccessoriesManual.this, R.string.repeat_0));
		speak(ResourceUtil.getStringFromResource(AccessoriesManual.this, R.string.previous_hg));
	}
		...
		public boolean onTouch(View v, MotionEvent event) {
			...
			case R.id.num1Button:
				...
				if (ACTION_DOWN == event.getAction()) {
					...
					speak(ResourceUtil.getStringFromResource(AccessoriesManual.this,R.string.not_assign));
					num1Button.setBackgroundResource(R.drawable.btn_normal);
					launchApp.putExtra(BrailleCommonUtil.APP_NAME_INTENT,"calculator.txt");
			...
			case R.id.num2Button:
				...
				if(event.getAction() == MotionEvent.ACTION_DOWN) {
					...
					launchApp.putExtra(BrailleCommonUtil.APP_NAME_INTENT,"calendar.txt");
					launchApp.putExtra("className","ManualMenu");
					launchApp.setClassName(PackageUtil.PACKAGE,PackageUtil.NOTEPADREAD);
					startActivity(launchApp);
					finish();
