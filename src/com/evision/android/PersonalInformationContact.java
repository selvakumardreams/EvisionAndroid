...
public class PersonalInformationContact extends BaseActivity {
	...
	String str ="",reStr="",PersonalInformationName="";
			...
			public boolean onTouch(View v, MotionEvent event) {
				if (ACTION_DOWN == event.getAction()) {
					...
					if (isFgKeypress == true) {
						if(reStr==""|| reStr==null) {
							speak(ResourceUtil.getStringFromResource(PersonalInformationContact.this,R.string.PersonalInformation_enter));
						} else {
							Intent launchApp = new Intent();
							launchApp.setFlags(Intent.FLAG_ACTIVITY_CLEAR_WHEN_TASK_RESET);
							launchApp.setClassName("com.evision.android", "com.evision.android.PersonalInformationAddress"); 
							launchApp.putExtra("PersonalInformationName", PersonalInformationName);
							launchApp.putExtra("PersonalInformationContact", reStr);
							startActivity(launchApp);
							finish();
						}
					}
					...
					if (starHPressed) {
						...
						if (reStr!=null) {
							if (reStr.length()!=0) {
								...
								speak(ResourceUtil.getStringFromResource(PersonalInformationContact.this,R.string.nonum_delete));
						}
					}
					lookuptable();
	...
	public void ttsMenu() {
		speak(ResourceUtil.getStringFromResource(PersonalInformationContact.this,R.string.PersonalInformation_contnum));
		speak(ResourceUtil.getStringFromResource(PersonalInformationContact.this,R.string.PersonalInformation_delete));
	}
}
