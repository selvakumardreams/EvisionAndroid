...
public class PersonalInformationBloodGroup extends BaseActivity {
	...
	protected static final String TAG = "PersonalInformationBloodGroup";
	...
	public String reStr="",PersonalInformationName="",PersonalInformationContact="",
			PersonalInformationAddress="",PersonalInformationGPSLocation="";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		PersonalInformationGPSLocation = this.getIntent().getStringExtra("PersonalInformationGPSLocation");
				...
				if (ACTION_DOWN == event.getAction()) {
					...
					if (isFgKeypress == true) {
						...
						if((reStr== "") || (reStr == null) || (reStr == " ")) {
							...
							speak(" saved");
							SharedPreferences value1 = getSharedPreferences(PREFS_NAME,0);
							SharedPreferences.Editor editor = value1.edit();
							editor.putString("PersonalInformationName", PersonalInformationName);
							editor.putString("PersonalInformationContact", PersonalInformationContact);
							editor.putString("PersonalInformationAddress", PersonalInformationAddress);
							editor.putString("PersonalInformationGPSLocation", PersonalInformationGPSLocation);
							editor.putString("PersonalInformationBloodGroup", reStr);
							editor.commit();
	...
	public void onInit(int status) {
		speak("enter your blood group and select F g to save");
