...
public class TransferMissCall extends BaseActivity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		UpdatedMissCallList dialcall = new UpdatedMissCallList();
		dialcall.execute();
				...
				if (ACTION_DOWN == event.getAction()) {
					...
					if(scrollUp == true) {
						if (isFileExit() == true) {
							...
							stop();
							speak(ResourceUtil.getStringFromResource(TransferMissCall.this,R.string.moveMiscal_empty));
						}
					}
	...
	private void ttsForEbookListMenu() {
		stop();
		speak(ResourceUtil.getStringFromResource(TransferMissCall.this,R.string.moveMiscal_welcome));
		speak(ResourceUtil.getStringFromResource(TransferMissCall.this,R.string.please));
		speak(ResourceUtil.getStringFromResource(TransferMissCall.this,R.string.scroll_up));
		speak(ResourceUtil.getStringFromResource(TransferMissCall.this,R.string.scroll_down));
		speak(ResourceUtil.getStringFromResource(TransferMissCall.this,R.string.fg_save));
	}
	...
	private class UpdatedMissCallList extends AsyncTask<String , Void, String> {  
