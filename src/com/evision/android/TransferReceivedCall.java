...
public class TransferReceivedCall extends BaseActivity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		UpdatedRecevieCallList dialcall = new UpdatedRecevieCallList();
		dialcall.execute();
					...
					if (isFgKeypress == true) {
						if ((isFileExit() == true)) {
							...
							if(saveName == "Unknown") {
								...
								speak("The Conatct Name already Saved");
							}
						} 
					}
				...
				if (ACTION_DOWN == event.getAction()) {
					...
					if (scrollUp == true) {
						if (isFileExit() == true) {
							...
							stop();
							speak(ResourceUtil.getStringFromResource(TransferReceivedCall.this,R.string.moveRevcal_empty));
						}
					}
	...
	private void ttsForEbookListMenu() {
		stop();
		speak(ResourceUtil.getStringFromResource(TransferReceivedCall.this,R.string.moveRevcal_welcome));
		speak(ResourceUtil.getStringFromResource(TransferReceivedCall.this,R.string.please));
		speak(ResourceUtil.getStringFromResource(TransferReceivedCall.this,R.string.scroll_up));
		speak(ResourceUtil.getStringFromResource(TransferReceivedCall.this,R.string.scroll_down));
		speak(ResourceUtil.getStringFromResource(TransferReceivedCall.this,R.string.fg_save));
	}
	...
	private class UpdatedRecevieCallList extends AsyncTask<String , Void, String> {  
